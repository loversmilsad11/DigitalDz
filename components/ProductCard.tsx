...
export default function ProductCard({ id, name, description, price, slug, currency, addToCartLabel, image }: ProductCardProps) {
  ...
  const handleAddToCart = (e: React.MouseEvent) => {
    e.preventDefault();
    addItem({ id, name, price, slug, image });
    setAdded(true);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div style={{ padding: '0 0.5rem 0.5rem', display: 'flex', flexDirection: 'column', flex: 1 }}>
          ...
          <div style={{ 
            ...
            <button 
              ...
              style={{ 
                ...
                alignItems: 'center', 
                justifyContent: 'center',
                boxShadow: added ? '0 4px 15px rgba(34, 197, 94, 0.4)' : '0 4px 15px rgba(192, 38, 211, 0.4)',
