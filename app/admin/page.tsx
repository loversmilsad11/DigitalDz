...
export default async function AdminDashboardOverview() {
  ...
  const stats = [
    ...
    { label: 'إجمالي الطلبات', value: 0, icon: ShoppingCart, color: 'text-amber-400' },
    { label: 'إجمالي المستخدمين', value: 0, icon: Users, color: 'text-blue-400' },
  ];

  return (
    <div className="fade-in">
      <h1 className="title-font gradient-text" style={{ fontSize: '2.25rem', fontWeight: 900, marginBottom: '2.5rem' }}>نظرة عامة</h1>
      ...
      <div className="glass-morphism" style={{ marginTop: '3rem', padding: '2.5rem', borderRadius: '2.5rem', border: '1px solid var(--glass-border)', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'relative', zIndex: 1 }}>
          <h2 className="title-font" style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '1.25rem', color: 'white' }}>أهلاً بك في لوحة الإدارة</h2>
          <p style={{ color: 'var(--foreground-muted)', lineHeight: 1.8, fontSize: '1.1rem', maxWidth: '800px' }}>
            هنا يمكنك إدارة متجرك الإلكتروني، تتبع الطلبات، وإضافة منتجات جديدة. واجهتك مصممة لتكون بسيطة وسهلة الاستخدام.
          </p>
        </div>
        {/* Decorative element */}
