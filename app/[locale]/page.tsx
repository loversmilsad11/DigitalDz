          ...
          <div style={{ maxWidth: 900, position: 'relative', zIndex: 1 }}>
            ...
            <FadeIn delay={0.8}>
              <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                <Link href={`/${locale}/products`} className="btn-primary" style={{ fontSize: '1.2rem', padding: '1.3rem 3rem', borderRadius: '1.5rem', textDecoration: 'none' }}>
                  {t('cta')}
                </Link>
                <Link href={`/${locale}/about`} className="glass-morphism" style={{ padding: '1.3rem 3rem', borderRadius: '1.5rem', color: '#fff', textDecoration: 'none', fontWeight: 600, fontSize: '1.2rem' }}>
                  {nt('contact')}
                </Link>
              </div>
            </FadeIn>
      ...
      <section className="container" style={{ padding: '4rem 0' }}>
        <FadeIn>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3.5rem' }}>
            ...
            <Link href={`/${locale}/products`} style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 700, fontSize: '1.1rem' }}>
              {t('cta')} &rarr;
            </Link>
          </div>
        </FadeIn>
            ...
            <div style={{ display: 'flex', gap: '6rem' }}>
              <div>
                 ...
                 <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
                    <li><Link href={`/${locale}`} style={{ color: 'var(--foreground-muted)', textDecoration: 'none' }}>الرئيسية</Link></li>
                    <li><Link href={`/${locale}/products`} style={{ color: 'var(--foreground-muted)', textDecoration: 'none' }}>المنتجات</Link></li>
                    <li><Link href={`/${locale}/faq`} style={{ color: 'var(--foreground-muted)', textDecoration: 'none' }}>الأسئلة الشائعة</Link></li>
                 </ul>
              </div>
              <div>
